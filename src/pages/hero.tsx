...
export default function Hero(){
  return (
    <div className="flex flex-col px-4 md:px-8 py-8 md:flex-row md:justify-between items-center transition-transform">
      <div className="flex flex-col gap-4 md:gap-8 md:w-[40%]">
        ...
        <div>
          <button className="bg-sky-900 text-white px-6 py-2 rounded shadow-xl text-lg hover:bg-sky-600 transition-colors" type="button">Saiba Mais</button>
        </div>
      </div>
